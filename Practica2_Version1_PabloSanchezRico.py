...
class Monitor():
    ...
    def yes_cars_south(self):
        return self.inside_north.value == 0 and self.inside_pedestrian.value == 0
        
    def yes_cars_north(self):
        return self.inside_south.value == 0 and self.inside_pedestrian.value == 0
        
    def yes_pedestrian(self):
        return self.inside_south.value == 0 and self.inside_north.value == 0
